                        ...
                        <b-row class="text-center">
                          <b-col>
                            ...
                            <b-row>
                              <b-col>Price:</b-col>
                              <b-col>
                                <input class="form-control"  min="0" type="number" v-model="card.Price" />
                              </b-col>
                            </b-row>
                            <b-row>
                              <b-col>Stack Size:</b-col>
                              <b-col>
                                <input class="form-control"  min="0" type="number" v-model="card.StackSize" />
                              </b-col>
                            </b-row>
                            ...
                            <b-row>
                              <b-col>Level:</b-col>
                              <b-col>
                                <input class="form-control"  min="0" type="number" v-model="card.Level" />
                              </b-col>
                            </b-row>
...
export default {
  ...
  mounted() {
    axios
      .get(process.env.VUE_APP_ARKFURY_API_ENDPOINT + "/Dinosaur?Sort=-IsActive,+Name&IncludeInActive=true&" + this.jsonPaging())
      .then(response => {
        this.errored = false;
  ...
  methods: {
    ...
    saveDinosaur: function(args) {
      ...
      axios
        .post(process.env.VUE_APP_ARKFURY_API_ENDPOINT + "/Dinosaur/Update", {
          Name: dino.Name,
          Type: dino.Type,
