...
namespace ArkFury.Common
{
    public class AppSettings
    {
        public class ConnectionString
        {
            ...
            public virtual string OpenArkFury { get; set; } = "https://api.openweathermap.org";
            public virtual string ArkShopMySql { get; set; }
        }
        ...
        public class ApiKey
        {
            ...
            public virtual string OpenArkFury { get; set; }
        }
        ...
        public virtual string PaymentNotificationEmailList { get; set; }

        public virtual string EntityAssemblyName => $"ArkFury.Entities";
