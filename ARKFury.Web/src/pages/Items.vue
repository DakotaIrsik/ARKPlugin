                      ...
                      <b-row>
                        <b-col>
                          <p style="font-size:large;">
                            <b>{{card.Quality.Name}} {{card.Name}} x {{card.StackSize}}</b>
                          </p>
                          <p>
...
export default {
  ...
  mounted() {
    axios
      .get(process.env.VUE_APP_ARKFURY_API_ENDPOINT + "/Item?Sort=-IsActive,+Name&IncludeInActive=false&" + this.jsonPaging())
      .then(response => {
        this.errored = false;
